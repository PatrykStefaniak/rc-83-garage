            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-3xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <button
                            className="gradient-primary text-primary-foreground shadow-glow hover:scale-105 transition-smooth group text-lg px-8"
                        >
                            Get a Quote
                            <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                        </button>
                        <button
                            className="border-border-dark hover:bg-accent transition-smooth text-lg px-8"
                        >
                            View Gallery
                        </button>
                    </div>
